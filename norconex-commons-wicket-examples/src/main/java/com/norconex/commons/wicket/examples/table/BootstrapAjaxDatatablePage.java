...
import com.norconex.commons.wicket.bootstrap.table.BootstrapAjaxDataTable;
import com.norconex.commons.wicket.examples.BaseExamplePage;

public class BootstrapAjaxDatatablePage extends BaseExamplePage {
	private static final long serialVersionUID = 1L;

	public BootstrapAjaxDatatablePage(final PageParameters parameters) {
		super(parameters);
        ...
        DataTable<Contact, String> dataTable = 
                new BootstrapAjaxDataTable<>("table", columns, dataProvider, 5);
        add(dataTable);
    }
}
